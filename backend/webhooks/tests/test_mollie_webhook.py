...
def simulate_webhook(payment_id, status, webhook_url="http://localhost:8080/webhook/mollie"):
    ...
    try:
        ...
        print("Make sure the webhook server is running with: python backend/webhooks/mollie/webhook_handler_production.py 8080 (or the PHP handler is deployed at /webhooks/mollie/webhook_handler_plesk.php)")
