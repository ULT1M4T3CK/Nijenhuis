(() => {
    ...
    const t = {
      nl: {
        ...
        index_camping_description: "Geniet van een unieke kampeerervaring midden in het prachtige natuurgebied Weerribben. Onze seizoenscamping is open van 1 april tot 31 oktober en biedt een rustige, gezellige omgeving voor uw caravan.",
        ...
        prices_season: "Seizoen: 1 april - 31 oktober 2025",
        ...
        camping_overview_seasonal_title: "Seizoenscamping met caravans",
        camping_overview_seasonal_description: "Onze camping is een seizoenscamping waar caravans het hele jaar door kunnen blijven staan. Het is geen grote camping maar zeer gezellig. Elke plaats heeft een eigen aanlegplaats.",
      ...
      de: {
        ...
        prices_season: "Saison: 1. April – 31. Oktober 2025",
        ...
        camping_overview_seasonal_title: "Saisoncamping mit Wohnwagen",
        camping_overview_seasonal_description: "Unser Campingplatz ist eine Saisoncamping, wo Wohnwagen das ganze Jahr über stehen bleiben können. Es ist kein großer Campingplatz, aber sehr gemütlich. Jeder Platz hat einen eigenen Bootsanleger.",
      ...
      en: {
        ...
        prices_season: "Season: 1 April – 31 October 2025",
        ...
        camping_overview_seasonal_title: "Seasonal Camping with Caravans",
        camping_overview_seasonal_description: "Our campsite is a seasonal camping where caravans can stay all year round. It's not a large site but very friendly. Each pitch has its own mooring.",
    ...
    function applyTranslations(lang) {
      ...
      document.querySelectorAll("[data-i18n]").forEach(el => {
        ...
        const htmlAllowedKeys = new Set([
          ...
          'jachthaven_ligplaatsen_cta',
          'footer_bottom', 'hero_book_badge'
        ]);
        if (htmlAllowedKeys.has(key)) {
          el.innerHTML = value;
        } else {
